...
public class myApp extends Application {
    ...
    public void onCreate() {
        ...
        Parse.initialize(this, "HPOp4z13o6yiWhgx1jCCuISLfoU74xylwgo5bVZH", "s40kjTkWuAYrdM3LB1cjrY6KYJSJwEkugAndC9jN");
        ...
        ParsePush.subscribeInBackground("sleimpn", new SaveCallback() {
            @Override
            public void done(ParseException e) {
