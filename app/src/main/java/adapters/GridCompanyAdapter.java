 ...
 */
public class GridCompanyAdapter extends BaseAdapter {

    private static final String LOG_TAG = "LOG";
    Context context;
    LayoutInflater inflater;

    private List<Company> stands= null;
    private List<Company> arraylist;

    public GridCompanyAdapter(Context context,
                            List<Company> standsapp) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if(stands.get(position)!=null){
            ...
            final ParseFile photoFile = stands.get(position).getLogo().getParseFileV1();
