 ...
 */
public class CompanyDirectoryFragment2 extends Fragment{
    ...
    public static CompanyDirectoryFragment2 newInstance(Company company,boolean b) {

        // Instantiate a new fragment
        bool = b;

        CompanyDirectoryFragment2 fragment = new CompanyDirectoryFragment2();
...
*/
        ...
        if (com != null) {
            ...
            if(com.getheaderImage()!=null){
                ParseFile header = com.getheaderImage().getParseFileV1();
                if (header != null) {
