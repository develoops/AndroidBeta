...
public class myApp extends Application {
    ...
    public void onCreate() {
        ...
        Parse.initialize(this, "2oDV5AaHreo4xA86ik3znuNA4zV2VnPcyalkoQVo", "jGm39YuMJtI9GYbvCvmFrcZlB0gyZM1FvjPq2EQw");
        ...
        ParsePush.subscribeInBackground("fmca", new SaveCallback() {
            @Override
            public void done(ParseException e) {
