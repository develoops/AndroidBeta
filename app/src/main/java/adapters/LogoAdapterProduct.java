 ...
 */
public class LogoAdapterProduct extends BaseAdapter {
    Context context;
    LayoutInflater inflater;
    public myApp myapp;

    private List<Company> standList = null;
    private ArrayList<Company> arraylist = null;
    ...
    public LogoAdapterProduct (Context context,
                              List<Company> stands) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if(standList.get(position)!=null){
            ...
            if(standList.get(position).getLogo()!=null){
                ...
                final ParseFile photoFile = standList.get(position).getLogo().getParseFileV1();
                if (photoFile != null) {
