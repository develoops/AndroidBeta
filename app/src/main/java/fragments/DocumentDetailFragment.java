...
public class DocumentDetailFragment extends Fragment {
    ...
    public static DocumentDetailFragment newInstance(MobiFile url) {
        ...
        if(url.getParseFileV1()!=null){
            urlDocument = url.getParseFileV1().getUrl();

        }
        else {
            urlDocument = url.geturlFile();
        }
