...
public class myApp extends Application {
    ...
    public void onCreate() {
        ...
        Parse.initialize(this, "QCTBBRsJDMeGUXVhNCGxcFASIJakzVYD2BcPhZzA", "lOCiUzOhiqw5dis3ghzBaz35EG79zxBaJqkCWsZa");
        ...
        ParsePush.subscribeInBackground("sochinut", new SaveCallback() {
            @Override
            public void done(ParseException e) {
