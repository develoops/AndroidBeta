...
public class myApp extends Application {
    ...
    public void onCreate() {
        ...
        Parse.initialize(this, "wL5IvbG9xnu7A55DkyAP0tLqfG45o7g9DMj2erhT", "mLkYoJ0LZx2utfYtwJYAWxURVVDYfHiZp0EhNOiv");
        ...
        ParsePush.subscribeInBackground("urolchi", new SaveCallback() {
            @Override
            public void done(ParseException e) {
