...
public class myApp extends Application {
    ...
    public void onCreate() {
        ...
        Parse.initialize(this, "Xp0hksbFeO1LwL5K1fRst3jRUBz6EPiOBydprLEA", "uVFb6YXCEdbITspgnCT7XYCSYO8NzwxaNbdetEF6");
        ...
        ParsePush.subscribeInBackground("gastronomicon", new SaveCallback() {
            @Override
            public void done(ParseException e) {
