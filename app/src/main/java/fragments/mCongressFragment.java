...
public class mCongressFragment extends Fragment{
    ...
    public static mCongressFragment newInstance(Company mobiCongress) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(mCongress!=null){
            ...
            ParseFile header = mCongress.getheaderImage().getParseFileV1();
            ParseFile logo = mCongress.getLogo().getParseFileV1();
            if (header != null) {
