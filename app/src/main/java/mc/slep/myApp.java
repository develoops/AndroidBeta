...
public class myApp extends Application {
    ...
    public void onCreate() {
        ...
        Parse.initialize(this, "K0iCQwklhFUDhTJgy60u1HTDoQZyoTEmXfKa88i1", "hVbSzEKTaHiYGfcWCeAeyYMfeiVvyOoSyYrW6nnR");
        ...
        ParsePush.subscribeInBackground("slep", new SaveCallback() {
            @Override
            public void done(ParseException e) {
