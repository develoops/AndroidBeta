...
public class SpeakerDetailAdapter extends BaseAdapter  {
    ...
    public SpeakerDetailAdapter(Context context,
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if(bool){
            ...
            holder.fl.setBackgroundColor(context.getResources().getColor(R.color.companyTerciario));
            holder.rl.setBackgroundColor(context.getResources().getColor(R.color.companyTerciario));
            holder.relativeLayout.setBackgroundColor(context.getResources().getColor(R.color.companyTerciario));
            ...
            if(actorList.get(position).getCompanies()==null){
                ...
                if(actorList.get(position).getPerson()!=null){
                    if(actorList.get(position).getPerson().getCompany()!=null){
                        holder.company_speaker.setText(actorList.get(position).getPerson().getCompany().getName());
                        if(actorList.get(position).getPerson().getCompany().getLocation()!=null){
                            if(actorList.get(position).getPerson().getCompany().getLocation().getCountryPlace()!=null){
                                holder.country_speaker.setText(actorList.get(position).getPerson().getCompany().getLocation().getCountryPlace().getName());
                            }
        ...
        if(actorList.get(position).getPerson().getImage()!=null){
            ...
            holder.icon.setBackgroundColor(context.getResources().getColor(R.color.companyTerciario));
